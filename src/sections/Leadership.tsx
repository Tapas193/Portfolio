      ...
      <div className="mx-auto max-w-6xl px-6 md:px-8">
        ...
        <div className="flex flex-col gap-6">
          {leadership.map((item, idx) => (
            <motion.div
              key={item.role}
              className="rounded-xl border border-line bg-white p-8 transition-shadow duration-300 hover:shadow-[0_18px_40px_-24px_rgba(17,17,17,0.3)] sm:p-10"
            ...
            >
              <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
                <div className="max-w-md">
                  <span className="font-mono text-xs font-medium tracking-[0.18em] uppercase text-fog">
                    {item.period}
                  </span>
